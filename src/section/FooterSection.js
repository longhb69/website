...
export default function FooterSection() {
    return (
        <section className="bg-[#1A0B33] text-white w-full h-full py-10">
            <div className="w-[80%] mx-auto flex flex-col lg:flex-row gap-10">
                <div className="w-full lg:w-[30%] space-y-4">
                    <p>Cơ quan chủ quản: Công ty Cổ phần Đầu tư và Thương mại HB.</p>
                    <p>
                        Mã số doanh nghiệp: 5400490220 do Sở Kế hoạch và Đầu tư Thành phố Hòa Bình cấp lần đầu ngày 19/03/2018, sửa đổi lần thứ 6 ngày
                        26/12/2024.
                    </p>
                    <div>
                        <div>
